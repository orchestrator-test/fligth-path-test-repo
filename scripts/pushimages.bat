...
echo "pushing image flightpathtestrepo"
%CONTAINER_RUNTIME% tag flightpathtestrepo %REGISTRY_URL%/%REGISTRY_NAMESPACE%/flightpathtestrepo
%CONTAINER_RUNTIME% push %REGISTRY_URL%/%REGISTRY_NAMESPACE%/flightpathtestrepo

echo "pushing image flightpathtestrepo-buildstage"
%CONTAINER_RUNTIME% tag flightpathtestrepo-buildstage %REGISTRY_URL%/%REGISTRY_NAMESPACE%/flightpathtestrepo-buildstage
%CONTAINER_RUNTIME% push %REGISTRY_URL%/%REGISTRY_NAMESPACE%/flightpathtestrepo-buildstage
